...
class ScreenEditSubcategory extends StatelessWidget {
  const ScreenEditSubcategory(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Изменить подкатегорию')),
      body: ChangeNotifierProvider(
          create: (context) =>
              ModelScreenNewEditSubcategory.edit(category, isSelectedBudget),
              ...
              return ListView(
                ...
                children: [
                  ...
                  ButtonAddEditCategory(
                    ...
                    icons: Icons.create,
                    onPressed: () =>
                        model.onPressedButtonCreateSubcategory(context),
                  )
                ],
              );
            },
