...
import 'package:budget/features/finanse/pages/add_finance/page_add_finance.dart';
import 'package:budget/features/finanse/pages/category/page_category.dart';
import 'package:budget/features/finanse/pages/finance/model_page_finance.dart';
...
class WidgetSwitchFinance extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final modelApp = context.watch<ModelApp>();
