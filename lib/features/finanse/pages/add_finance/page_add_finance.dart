...
import 'package:budget/features/finanse/pages/add_finance/model_page_add_finance.dart';
import 'package:budget/features/finanse/pages/add_finance/model_widget_card_category.dart';
    ...
    return FutureBuilder<List<SubCategory>>(
      ...
      builder: (context, snapshot) {
        ...
        return ExpansionTile(
          ...
          children: listSubCategory.map((subCategory) {
            return WidgetCardSubCategory(subCategory: subCategory);
          }).toList(),
        );
      },
